  ...
  Widget build(BuildContext context) {
    return RichText(
      ...
      text: const TextSpan(
        ...
        children: <TextSpan>[
          TextSpan(text: 'Here we provide a set of default queries for which we extracted data. You can select one of these and the SPARQL query will be executed on our GraphDB server.\n'
              , style: TextStyle(fontWeight: FontWeight.normal,fontSize: constants.SIZE_TEXT,height: 2)),
